...
public class FW001Filler implements AbstractPdfFiller {
    @Override
    public void fillForm(DefendantInfo info) {
        ...
        try {
            ...
            pdf.save(FOLDER_NAME + "fw001 result.pdf");
            pdf.close();
...
////        fillers.implementations.FW001Filler obj = new fillers.implementations.FW001Filler();
////        obj.fillForm(null);
//    }
}
